 ...
 * @author By_syk
 */
public class GraphicC11Translator {
    private static GraphicC11Translator translator = null;
    ...
    private GraphicC11Translator() {}
    
    public static GraphicC11Translator getInstance() {
        if (translator == null) {
            translator = new GraphicC11Translator();
        }
    ...
    public static void main(String[] args) {
        int target = 0x009A2F19;
        System.out.println(target);
        System.out.println(Integer.toHexString(target));
        System.out.println(Integer.toHexString(target|0xFF000000));
    }
